...
/**
 * Redux Action To Get ApiKeys Status
 */
export const getApiKeyStatus = (user) =>({
    type: API_KEYS_GET_STATUS,
    payload: {user}
 });
 
/**
 * Redux Action To Set ApiKeys Status
 */
export const setApiKeysStatus = (data) => ({
    type : API_KEYS_SET_STATUS,
    payload: data 
});